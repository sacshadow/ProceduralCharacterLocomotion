...
public class HAC_Punch : HumanoidAction {
	...
	public override void Begin() {
		...
		groundMovement.speed = combo ? 2f : 2.2f;
		// if(combo)
			// groundMovement.SetPercentage(0.15f);
		// groundMovement.speed = combo ? 1.25f : 1f;
	...
	public override IEnumerator ActionUpdate() {
		...
		constraintAttribute.stiffness = 0.9f;
